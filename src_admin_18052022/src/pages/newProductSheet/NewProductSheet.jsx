...
export default function NewProductSheet() {
  ...
  const createInfoProduct = () => {
    ...
    console.log('info Product đã upload ảnh =>', JSON.stringify(infoProduct[0]))
  }
      ...
      Variant: [
        {
          ...
          count: 10,
          sku: 'SKU1',
          imageLink: 'https://api.newee.asia:8001/Photos/Product/637709663191262501.jpg', //ẢNH VARIANT - SỬA SAU
        },
        {
          PropertyName: 'phân loại sp 1',
          ...
          count: 10,
          sku: 'SKU2',
          imageLink: 'https://api.newee.asia:8001/Photos/Product/637709486027400005.jpg',
        },
      ],
    },
    {
      ...
      Variant: [
        {
          ...
          count: 10,
          sku: 'SKU1',
          imageLink: 'https://api.newee.asia:8001/Photos/Product/637709428206392722.jpg',
        },
        {
          PropertyName: 'phân loại sp 2',
          ...
          count: 10,
          sku: 'SKU2',
          imageLink: 'https://api.newee.asia:8001/Photos/Product/637709425413416893.jpg',
        },
      ],
    },
  ])
  ...
  const headers = ['Attribute Name', 'Attribute Type', 'Data Type', 'Primary Key', 'Input Array']
