...
import InfoProduct from '../../components/upload/promotions/InfoProduct'
import {
  createProducts,
  createVariant,
  fetchProducts,
...
export default function AddPromotions() {
  ...
  const handleSubmitCreateProduct = async () => {
    ...
    console.log('4/4 thông tin form 2/2 => tạo Variant + resuilt 2/4', saveVariantProduct)
    return
        ...
        <>
          ...
          <div className="newProduct-container">
            <div className="newProduct-info">
              <label>#1 - Chọn sản phẩm - thời gian (1/3)</label>
