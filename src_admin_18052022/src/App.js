...
import ProductListEnable from './pages/productListEnable/ProductListEnable'
// Promotion
...
import WhishList from './pages/whishList/WishList'
import './stylesheets/comment.css'
import './stylesheets/form.css'
import './stylesheets/resizeButton.css'
          ...
          <Suspense fallback={<div>Loading...</div>}>
            {token ? (
              <Switch>
                ...
                <Route path="/products-enable" component={ProductListEnable} />
