...
class MultipleImageEditVariant extends React.Component {
  state = {
  ...
  handleUploadClick = (event) => {
    ...
    var url = reader.readAsDataURL(fileValue);
    ...
    console.log("url đây nà =>", url); // Would see a path?
    ...
    this.props.handleClick(this.props.index, event.target.files[0]);
  };
  ...
  renderInitialState() {
    ...
    console.log("this.props.dataVariantRowLink", this.props.dataVariantRowLink);
    return (
      <React.Fragment>
        <CardContent>
          <Grid container justify="center" alignItems="center">
            ...
            <label htmlFor="contained-button-file-multiple">
              <Fab component="span" className={classes.button}>
                {this.props.dataVariantRowLink ? (
                  <img
                    width="100%"
                    className={classes.media}
                    src={this.props.dataVariantRowLink}
                    alt={"Newee asia edit variant"}
                  />
                ) : (
    ...
    return (
      <React.Fragment>
        <div className={classes.root}>
          ...
          <span className={classes.span}>Ảnh {this.props.index + 1}</span>
        </div>
      </React.Fragment>
    );
  }
